        ...
        <div className="grid md:grid-cols-3 gap-6 mt-12 max-w-6xl mx-auto">
          <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-gray-600">تحميل بأعلى جودة متاحة</p>
            </CardContent>
          </Card>
          ...
          <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-gray-600">تحميل سريع وموثوق</p>
            </CardContent>
          </Card>
          ...
          <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <CardContent className="p-6 text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">آمان تام</h3>
              <p className="text-gray-600">حماية كاملة لخصوصيتك</p>
            </CardContent>
          </Card>
        </div>
      </div>
